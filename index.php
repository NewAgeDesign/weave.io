            ...
            <span class="workspace">
                <span class="toolbar">
                    ...
                    <ul class="basic">
                        ...
                        <li id="move" title="move">
                            <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" id="arrow-circle-down" viewBox="0 0 24 24" width="512" height="512">
                        ...
                        <li id="zoom_into" title="zoom into">
