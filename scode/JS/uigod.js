...
io = {
    ...
    form: function () {
        ...
        function floatingLabels() {
            const formContainer = document.querySelector(".form"); // Parent Check
        ...
        function autoAdvanceCodeInputs() {
            ...
            inputs.forEach((input, index) => {
                input.addEventListener('input', function () {
                    ...
                    // Move focus to the next input if the current input has a character
        ...
        function handleFormSubmission() {
            document.querySelectorAll('form').forEach(form => {
                form.addEventListener('submit', function (event) {
                    ...
                    // Get the method and action from the form attributes
                    ...
                    io.in('ajax', method, action, data, function (res) {
                        if (res.status === 'info') {
                            form.reset();
                        }
                    });
...
io.in(conStyle, root, 'scode/JS/config.json');
